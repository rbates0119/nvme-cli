...
{
	__u16 vse = le16_to_cpu(vendor_specif_event & 0x2000) >> 13;
...
void nvme_show_events(__u8 entry, __u8 event)
{
	...
	case 1:
		printf("SMART / Health Log Snapshot Event: 0x01");
		break;
	case 2:
		printf("Firmware Commit Event: 0x02 ");
		break;
	case 3:
		printf("Timestamp Change Event: 0x03 ");
		break;
	case 4:
		printf("Power-on or Reset Event: 0x04 ");
		break;
	case 5:
		printf("NVM Subsystem Hardware Error Event: 0x05 ");
		break;
	case 6:
		printf("Change Namespace Event: 0x06 ");
		break;
	case 7:
		printf("Format NVM Start Event: 0x07 ");
		break;
	case 8:
		printf("Format NVM Completion Event:0x08 ");
		break;
	case 9:
		printf("Sanitize Start Event: 0X09 ");
		break;
	case 10:
		printf("Sanitize Completion Event:0x0A ");
		break;
	case 11:
		printf("Set Feature Event: 0x0B ");
		break;
	case 12:
		printf("Telemetry Log Created Event: 0x0C ");
		break;
	case 13:
		printf("Thermal Excursion Event0x0D ");
		break;
	default:
